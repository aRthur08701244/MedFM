...
class MedfmcColon(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = os.path.join(self.dataset_dir, "colon/images") # e.g. images
        self.split_path = os.path.join(self.dataset_dir, f"colon/split_tsai_medfmc_colon-{SHOT}shot-{TARGET}.json") # split_zhou_Food101.json
        self.split_fewshot_dir = os.path.join(self.dataset_dir, "colon/split_fewshot") # split_fewshot
