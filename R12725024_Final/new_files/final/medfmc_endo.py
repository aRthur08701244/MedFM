...
class MedfmcEndo(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = os.path.join(self.dataset_dir, "endo/images") # e.g. images
        self.split_path = os.path.join(self.dataset_dir, f"endo/split_tsai_medfmc_endo-{SHOT}shot-{TARGET}.json") # split_zhou_Food101.json
        self.split_fewshot_dir = os.path.join(self.dataset_dir, "endo/split_fewshot") # split_fewshot
